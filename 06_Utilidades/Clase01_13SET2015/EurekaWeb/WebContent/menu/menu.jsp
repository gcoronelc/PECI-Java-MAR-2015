...
<div id='cssmenu'>
	<ul>
      ...
      <ul>
        ...
        <li><a href='javascript: cargarPagina("procDeposito.jsp")'><span>Depósito</span></a></li>
    ...
    <li class='has-sub'><a href='#'><span>Consultas</span></a>
      <ul>
        <li><a href='javascript: cargarPagina("conClientes.jsp")'><span>Clientes</span></a></li>
        <li><a href='#'><span>Cuentas</span></a></li>
        <li><a href='javascript: cargarPagina("conMovimientos.jsp")'><span>Movimientos</span></a></li>
      </ul>
    </li>
