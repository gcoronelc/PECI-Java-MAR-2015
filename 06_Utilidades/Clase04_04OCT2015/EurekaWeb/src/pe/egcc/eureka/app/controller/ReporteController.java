...
public class ReporteController extends HttpServlet {
    ...
    } else if(path.equals("/RepoResumen")){
      repoResumen(request,response);
    }
	}

  private void repoResumen(HttpServletRequest request,
    ...
    try {
      ...
      lista = (List) cuentaService.getResumen(sucursal, moneda);     
      ...
      // Reporte
      String repoFile = "/pe/egcc/eureka/app/reports/repoResumen.jrxml";
