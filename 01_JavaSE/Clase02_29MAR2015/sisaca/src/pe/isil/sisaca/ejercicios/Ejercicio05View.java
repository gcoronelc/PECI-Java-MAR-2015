...
public class Ejercicio05View extends javax.swing.JFrame {

  public Ejercicio05View() {
    initComponents();
  }
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Programa que permite mostrar los promeros \"N\" numeros que la suma de sus digitos sea multiplos de 3 y 5");
        ...
        jLabel3.setText("Ingrese cantidad de numeros (N) :");
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
      ...
      Integer n = Integer.valueOf(cantidad);
      String resultado = "";
      Integer i = 1, conta = 0;

      while (true) {

        Integer sumaDigit = sumaDigitos(i);
        if (sumaDigit % 15 == 0) {
          resultado += i + " , ";
          conta++;
        }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(Ejercicio05View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new Ejercicio05View().setVisible(true);
      }
    });
  }
